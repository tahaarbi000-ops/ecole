...
import SupervisorsViewModal from './SupervisorsViewModal';
import SupervisorsFormModal from './SupervisorsFormModal';
 ...
 */
export default function SupervisorsPageBase({
  pageTitle,
  entityLabel,
  initialData,
  roleFieldKey,
  ...
  const filteredPeople = useMemo(() => {
    ...
    return people.filter((p) => {
      const matchesSearch = !term || `${p.name} ${p.last_name} ${p.phone}`.toLowerCase().includes(term);
